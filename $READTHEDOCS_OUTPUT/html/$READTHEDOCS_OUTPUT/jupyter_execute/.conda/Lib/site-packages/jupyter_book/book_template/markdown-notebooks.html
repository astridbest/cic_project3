...
<html lang="en" data-content_root="../../../../../../../" >
  ...
  <head>
    ...
    <title>Notebooks with MyST Markdown &#8212; Computing in Context - Astrid</title>
...
<link rel="preload" as="script" href="../../../../../../../_static/scripts/pydata-sphinx-theme.js?digest=26a4bc78f4c0ddb94549" />
    ...
    <script>var togglebuttonSelector = '.toggle, .admonition.dropdown';</script>
    <script>const THEBE_JS_URL = "https://unpkg.com/thebe@0.8.2/lib/index.js"; const thebe_selector = ".thebe,.cell"; const thebe_selector_input = "pre"; const thebe_selector_output = ".output, .cell_output"</script>
    <script>DOCUMENTATION_OPTIONS.pagename = '$READTHEDOCS_OUTPUT/jupyter_execute/.conda/Lib/site-packages/jupyter_book/book_template/markdown-notebooks';</script>
...
<a class="navbar-brand logo" href="../../../../../../../index.html">
    ...
    <img src="../../../../../../../_static/hi.png" class="logo__image only-light" alt="Computing in Context - Astrid - Home"/>
    <img src="../../../../../../../_static/hi.png" class="logo__image only-dark pst-js-only" alt="Computing in Context - Astrid - Home"/>
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../../../_sources/$READTHEDOCS_OUTPUT/jupyter_execute/.conda/Lib/site-packages/jupyter_book/book_template/markdown-notebooks.ipynb" target="_blank"
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">jupyter</span><span class="o">-</span><span class="n">book</span> <span class="n">myst</span> <span class="n">init</span> <span class="n">path</span><span class="o">/</span><span class="n">to</span><span class="o">/</span><span class="n">markdownfile</span><span class="o">.</span><span class="n">md</span>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./$READTHEDOCS_OUTPUT\jupyter_execute\.conda\Lib\site-packages\jupyter_book\book_template"
        },
